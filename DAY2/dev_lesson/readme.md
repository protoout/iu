...
- セットアップ
  ...
  -  「アイデアをカタチにする楽しさを感じつつ、つくる感覚を身に着ける」
...
#### 2. obnizの Wi-Fi 接続
  既に実施しているかもしれませんが、必要な方は[こちら](./obniz/01_start_obniz.md)をご確認ください。
...
> [!NOTE]
> [もしobnizで複数のパーツを同時に使いたい時はこちらを参考にしてください](.obniz/obniz-tips.md)
