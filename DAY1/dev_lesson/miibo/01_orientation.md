...
**✅岩手大学のmiiboのチャット画像添付したい**

**miiboのメリット**

- コードを書かなくても簡単に使える  
プログラミングが不要で初心者でもわかりやすいので、爆速でAI開発ができます。

- さまざまなサービスと繋げられる  
他のアプリやシステムと連携して使うことができます。

- 目的に合わせてさまざまなLLMを選べる  
  - 補足：LLMとは？  
  質問に答える、文章を書くなど、高性能な脳みそをもっているものです。

- 作成したAIをいろいろな場所で使える
Webサイトやアプリなど、どんなプラットフォームにも組み込むことができます。

- 個別の会話ができるAIを作れる  
ユーザーごとに合わせた会話をするAIを簡単に構築することができます。
...
初めてAIを触る方も、触ってみたけど活用しきれていないという方も、今回で「AIを使った！」という経験がこれから
触ってみたけどどうして良いか分からなくなってしまう人は、目的（企画）と手段（技術）をセットで考える訓練が必要です。

今日の仕事減らして！ではなく、 今日のこの書類仕事ワンクリックで終わらせて！ぐらい具体的な目的が必要です。
