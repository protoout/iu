...
- [Node-REDで自動化の仕組みを体験](./dev_lesson/node-red)
    - 担当: 柳澤
...
- クロージング
    ...
    - 宿題の案内
    - アンケート案内  
      [こちらをクリックして回答をお願いします](https://docs.google.com/forms/d/e/1FAIpQLSfWCsZx72dmPVyCzxYadUeaR1jRT_KtGFLerIMOQ6vV_JIWxw/viewform?usp=dialog)
    - 担当: のびすけ
