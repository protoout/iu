...
## 2. Difyで会話型AIをLINE Bot化するハンズオン

### 2-1. 準備: LINE公式アカウントと必要なキーの取得
...
### 2-6. 重要: LINEプラグインのバージョンを0.0.4に下げる
...
### 2-7. プラグインの設定（LINEのキーとDifyアプリを紐づけ）
