...
> [!IMPORTANT]
> 学習目標（ゴール）：
> - 生成AIやDifyでチャットアプリが動く体験をする
> - Difyでワークフローの操作イメージをざっくり掴む
>
> 行動目標（やること）：
> - Difyに触れながら、チャットアプリを作成する
> - Difyのプラグインを使い、LINEと連携する
...
## 実装授業2 14:50-15:20（30分）

> [!IMPORTANT]
> 学習目標（ゴール）：
> - RAGで「資料を根拠に答える」状態が作れることを体験する
> - どんな課題にRAGが効くか、判断軸をさっくり掴む
>
> 行動目標（やること）：
> - ナレッジを取り込み、RAG設定をして回答が変わることを確認する
...
## 自由制作 15:25-15:55（30分）
- [身近なテーマで実用的なAIチャットボットを作ろう](/IU25/07_challenge.md)
...
## 発表 16:00-16:30（30分）
- 1人1~2分程度、制作したLINEBotを共有したりPC画面を見せながら、こだわったポイント等を発表
