...
## 実装授業前のオリエンテーション 13:30-13:35（5分）
- [授業の進め方について](/IU25/01_orientation.md)

## 実装授業1 13:35-14:35（60分）
...
## 実装授業2 14:45-15:15（30分）

> [!IMPORTANT]
> 学習目標（ゴール）：
> - RAGの仕組みをイメージできるようになる
> - DifyでRAGを扱えるようになる
>
> 行動目標（やること）：
> - ナレッジを取り込み、RAG設定をして回答が変わることを体験する

### 授業本編

- [RAGを使った「盛岡の観光アドバイザーAIチャットボット」を作ろう](/IU25/06_rag.md)

## 自由制作 15:15-15:45（30分）
